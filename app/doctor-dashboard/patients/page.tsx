...
export default function PatientsClientPage() {
  ...
  const filteredPatients = patients.filter((patient) => {
    ...
    return (
      ...
      patient.insuranceProvider.toLowerCase().includes(query) ||
      patient.insuranceStatus.toLowerCase().includes(query)
    )
  })
  ...
  return (
    <DoctorLayoutWrapper activePage="patients">
      {/* Main content */}
        ...
        <div className="p-6">
          ...
          <div className="space-y-4">
            {filteredPatients.length === 0 ? (
              <p className="text-center text-sm text-[#86868b] dark:text-[#a1a1a6]">
