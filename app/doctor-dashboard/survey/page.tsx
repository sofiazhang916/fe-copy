                                    ...
                                    <div className="flex items-start justify-between">
                                      <div className="flex-1">
                                        ...
                                        <div className="mt-2 flex items-center gap-2">
                                          ...
                                          <span className="text-xs px-2 py-1 bg-[#e5e5ea] dark:bg-[#4a4a4c] rounded">
                                            Ref: {field.fieldReference}
                                          </span>
                                          {field.constraints?.min_value !== undefined && (
                                            <span className="text-xs px-2 py-1 bg-[#e5e5ea] dark:bg-[#4a4a4c] rounded">
                                              Min: {field.constraints.min_value}
                                            </span>
                                          )}
                                          {field.constraints?.max_value !== undefined && (
                                            <span className="text-xs px-2 py-1 bg-[#e5e5ea] dark:bg-[#4a4a4c] rounded">
                                          ...
                                          {field.constraints?.max_length !== undefined && (
                                            <span className="text-xs px-2 py-1 bg-[#e5e5ea] dark:bg-[#4a4a4c] rounded">
                                              Max Length: {field.constraints.max_length}
                                            </span>
                                          )}
                                          {field.constraints?.steps !== undefined && (
                                            <span className="text-xs px-2 py-1 bg-[#e5e5ea] dark:bg-[#4a4a4c] rounded">
                                              Steps: {field.constraints.steps}
                                            </span>
                                          )}
                                          ...
                                          {field.constraints?.randomize && (
                                            <span className="text-xs px-2 py-1 bg-[#e5e5ea] dark:bg-[#4a4a4c] rounded">
                                              Randomized
                                            </span>
                                          )}
                                          {field.constraints?.alphabetical_order && (
                                            <span className="text-xs px-2 py-1 bg-[#e5e5ea] dark:bg-[#4a4a4c] rounded">
                                              Alphabetical Order
                                            </span>
                                          )}
