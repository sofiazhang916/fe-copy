...
import { LogOut, Calendar, MessageSquare, FlaskRoundIcon as Flask, User, Search, Send } from "lucide-react"
                ...
                <div className="w-1/3 bg-white dark:bg-[#2c2c2e] rounded-l-lg shadow-sm border border-[#e5e5ea] dark:border-[#3a3a3c] border-r-0 overflow-hidden">
                  ...
                  <div className="overflow-y-auto h-[calc(100%-130px)]">
                    {conversations.map((conversation) => (
                      <div
                        key={conversation.id}
                        className={`p-4 border-b border-[#e5e5ea] dark:border-[#3a3a3c] cursor-pointer hover:bg-[#f5f5f7] dark:hover:bg-[#3a3a3c] ${
                          selectedConversation.id === conversation.id ? "bg-[#f5f5f7] dark:bg-[#3a3a3c]" : ""
                        }`}
